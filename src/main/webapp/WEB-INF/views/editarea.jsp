						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
					                  ...
					                  <div class="pt-2 pb-2">
					                     <div class="alpha"> <h5 class="card-title text-center pb-0 fs-4">Edit  Area Details </h5></div>
					                  </div>
					                  	 
					                 <form class="row g-3 needs-validation" action="updatearea" method="post" novalidate>
					                
								    <div class="col-12 mt-n2">
						                <label for="areaName" class="form-label fw-bold icon-blue">Area Name</label>
						                <input type="text" name="areaName" class="form-control" id="areaName" value="${area.areaName}" placeholder="Area Name" required>
									  ...
									  <div class="col-12 mt-n2 mb-1">
										  <label for="cityname" class="form-label fw-bold icon-blue">City Name</label>
										   <select name="cityid" class="form-control dropdown-white">
					                  ...
					                  <div class="col-12">
					                  	 <button class="btn btn-primary w-100" type="submit" >Update Area</button>
					                  </div>
					                 
					                  <div class="col-12 text-center">
						             	 <div class="login"> <p class="small">Back to <a href="listarea"><b>List</b> </a></div> </p>
						              </div>
