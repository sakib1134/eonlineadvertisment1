				...
				<div class="col-lg-12">
                  ...
                  <ul class="list-group list-group-flush">
                   <li class="list-group-item">
                      ...
                      <span class="fw-bold icon-blue">State Id:</span> <span class="value"> ${state.stateid}</span>
                    </li>
                    <li class="list-group-item">
                     
                      <span class="fw-bold icon-blue">State Name:</span><span class="value">  ${state.stateName }</span>
                   </li>
                  </ul>
                </div>
              </div>
