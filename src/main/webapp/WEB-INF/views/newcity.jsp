						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									  ...
									  <div class="pt-2 pb-2">
					                	  <div class="alpha"> <h5 class="card-title text-center pb-0 fs-4">Add City  </h5></div>
					                  </div>
					                  <form class="row g-3 needs-validation" action="savecity" method="post" novalidate>
										<div class="col-12 mt-n2">
					                      <label for="cityname" class="form-label fw-bold icon-blue">City Name</label>
					                      <input type="text" name="cityName" class="form-control" id="cityName" placeholder="cityName" required>
					                    ...
					                    <div class="col-12 mt-0">
					                      	<button class="btn btn-primary w-100" type="submit">Save City</button>
					                    </div>
					                    
					                     <div class="col-12 ">
					                        <div class="login"> <p class="small text-center">Do you want to add?<a href="newarea">Area</a></div></p>
					                     </div>
