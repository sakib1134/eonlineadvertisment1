							...
							<div class="card">
							 ...
							 <c:forEach items="${allarea}" var="a">
											...
											<tr>
												...
												<td>${a[4]}</td>
												<td>${a[5]}</td>
											    <td><a href="viewarea?areaid=${a[0]}"><i class="bi bi-eye"></i></a> |
											    <a href="deletearea?areaid=${a[0]}"><i class="bi bi-trash3"></i></a> | 
												<a href="editarea?areaid=${a[0]}"><i class="bi bi-pen"></i> </a>
												</td>
