...
<style>
   /* General Styling */
    ...
    /* Keep the first option white when the dropdown is not selected */
    .dropdown-white:invalid {
        color: white !important;
    }
</style>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-2 pb-2">
                    <div class="alpha"><h5 class="card-title text-center pb-0 fs-4"> AdBooking </h5></div>
                    <p class="text-center small">Enter your Ad Details</p>
                  </div>

                 <form class="row g-3 needs-validation" action="saveadvertisment" method="post" novalidate>
				    <div class="col-12">
				        <label for="adcontent" class="form-label">Ad Content</label>
				        <input type="text" class="form-control" id="adcontent" name="adcontent" required placeholder="Enter ad content">
				    ...
				    <div class="col-12">
				        ...
				        <input type="text" class="form-control" id="totalcost" name="totalcost" required placeholder="Enter total cost">
				        <div class="invalid-feedback">Please enter total cost!</div>
				    </div>
				
				    <div class="col-12">
				        <label for="paymentStatus" class="form-label">Choose a Status</label>
				    ...
				    <div class="col-12">
				        <button class="btn btn-custom w-100" type="submit">Submit Ad</button>
				    </div>
				</form>
...
<script>
    document.getElementById("paymentStatus").addEventListener("change", function () {
        this.style.color = "black"; // Change text color to black after selection
    });
</script>
</body>
