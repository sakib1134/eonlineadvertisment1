...
<tbody>
      ...
      <c:forEach items="${statelist}" var="s">
				...
				<td>${s.stateid}</td>
				<td>${s.stateName}</td>
				<td><a href="viewstate?stateid=${s.stateid}"><i class="bi bi-eye"></i></a> | 
				<a href="deletestate?stateid=${s.stateid}"><i class="bi bi-trash3"></i></a> | 
				<a href="editstate?stateid=${s.stateid}"><i class="bi bi-pen"></i> </a></td>
