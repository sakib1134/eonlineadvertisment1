            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3 zoom-in">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-2 pb-2">
                    <div class="alpha"> <h5 class="card-title text-center pb-0 fs-4">Change Password</h5></div>
                  ...
                  <form class="row g-3 needs-validation" action="updatepassword" method="post" novalidate>
                    ...
                    <div class="col-12 mt-n2">
                      ...
                      <input type="otp" name="otp" class="form-control" id="otp" placeholder="otp" required>
                  <!-- <div class="invalid-feedback">Please enter a valid Email address!</div>-->
                    </div>
            		...
            		<div class="col-12">
                      <button class="btn btn-custom w-100" type="submit">Change Password</button>
                    </div>
